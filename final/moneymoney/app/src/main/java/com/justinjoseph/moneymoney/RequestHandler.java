...
public class RequestHandler {
    ...
    public RequestHandler(Context context, View view, TextView budgetTextView, Integer fragmentContainerID, FragmentManager fm){
    ...
    public void requestTransactions(String startDate, String endDate) {
...
//        return null;
    ...
    public void viewsPopulater(JSONObject transactionsObject){
        Double budget = 0.00;
        try {
